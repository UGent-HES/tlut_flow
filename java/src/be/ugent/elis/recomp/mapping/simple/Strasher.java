...
public class Strasher {
	...
	public static void main(String[] args) throws IOException {
		...
		BasicAIG a = new BasicAIG(args[0]);
		
		BasicAIG strashed = new BasicAIG();
		strashed.copyStrash(a);
		
		strashed.printAAG(new PrintStream(new BufferedOutputStream(new FileOutputStream(args[1]))));
	}
