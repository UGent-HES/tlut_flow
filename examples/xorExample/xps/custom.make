...
# Project:/home/kheyse/private/tlut_flow/examples/xorExample/ise/system.xmp
#
...
# /home/kheyse/private/tlut_flow/examples/xorExample/ise/system.mhs
# The software specification of the system is in file :
# /home/kheyse/private/tlut_flow/examples/xorExample/ise/system.mss
...
#################################################################
# SOFTWARE APPLICATION TESTRECONFIGURATION
#################################################################

testReconfiguration_program: $(TESTRECONFIGURATION_OUTPUT) 

$(TESTRECONFIGURATION_OUTPUT) : $(TESTRECONFIGURATION_SOURCES) $(TESTRECONFIGURATION_HEADERS) $(TESTRECONFIGURATION_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/testreconfiguration_compiler.opt
	@mkdir -p $(TESTRECONFIGURATION_OUTPUT_DIR) 
	$(TESTRECONFIGURATION_CC) $(TESTRECONFIGURATION_CC_OPT) $(TESTRECONFIGURATION_SOURCES) -o $(TESTRECONFIGURATION_OUTPUT) \
	$(TESTRECONFIGURATION_OTHER_CC_FLAGS) $(TESTRECONFIGURATION_INCLUDES) $(TESTRECONFIGURATION_LIBPATH) \
	$(TESTRECONFIGURATION_CFLAGS) $(TESTRECONFIGURATION_LFLAGS) 
	$(TESTRECONFIGURATION_CC_SIZE) $(TESTRECONFIGURATION_OUTPUT) 
	@echo ""

testReconfiguration_programclean:
	rm -f $(TESTRECONFIGURATION_OUTPUT) 
