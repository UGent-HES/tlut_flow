/*****************************************************************************
* Filename:          /home/akulkarn/private/Desktop/git_try/tlut_flow/examples/xorExample/xpsV13_blaze_genesys/drivers/plb_xor_v1_00_a/src/plb_xor_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the plb_xor driver
...
XStatus PLB_XOR_SelfTest(void * baseaddr_p)
{
  ...
  PLB_XOR_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = PLB_XOR_mReadSlaveReg0(baseaddr, 0);
  ...
  PLB_XOR_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = PLB_XOR_mReadSlaveReg1(baseaddr, 0);
