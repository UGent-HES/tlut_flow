...
begin
  ...
  --USER logic implementation added here
    MULT4B: entity plb_mult4b_v1_00_a.treeMult4b
	port map (
		a => slv_reg0(C_SLV_DWIDTH-4 to C_SLV_DWIDTH-1),
		b => (others => '0'),
		o => slv_reg1(C_SLV_DWIDTH-12 to C_SLV_DWIDTH-1)
	);
	slv_reg1(0 to C_SLV_DWIDTH-13) <= (others => '0');
